        ...
        <div class="col-12">
            ...
            <form action="{{ route('cms-applications.store') }}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" aria-describedby="nameHelp" placeholder="Моя Лучшая CMS">
                ...
                <div class="form-group">
                    ...
                    <input type="url" class="form-control" id="url" name="url" aria-describedby="urlHelp" placeholder="http://my-best-cms.net">
                    <small id="urlHelp" class="form-text text-muted">URL (домен) приложения.</small>
                </div>
                <div class="form-group">
                    <label for="app_key">Ключ приложения</label>
                    <input type="text" class="form-control" id="app_key" name="app_key" aria-describedby="app_keyHelp" placeholder="Любая последовательность символов">
